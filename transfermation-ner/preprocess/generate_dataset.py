...
def main():
    ...
    for i,tempfile in enumerate([args.input_train_data,args.input_test_data,args.input_dev_data]):
        fo = open(os.path.join(args.output_dir, file_names[i]), "w")
    ...
    #     # add new line at the end fo the file to break the sentence
    #     fo.write("\n")
    print("Number of training sentences: {}".format(nb_sent[0]))
    print("Number of testing sentences: {}".format(nb_sent[1]))
    print("Number of development sentences: {}".format(nb_sent[2]))
